...
} private static int changegiven(Change change, double currency) {
	int counter;
...
class Change {private static Scanner scanner=new Scanner(System.in); static{scanner.useDelimiter(System.getProperty("line.separator"));}
	double change;
} 
