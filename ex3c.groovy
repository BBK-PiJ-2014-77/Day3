...
onep = changegiven( p2, 0.01);
	
println ("Your change in notes is " + fifty + " fifties, " + twenty + " twenties, " + ten + " tens, " + five + " fives.");
println ("Your change in coins is " + two + " two pound coins, " + one + " one pound coins, " + fiftyp + " fifty pence coins " + twentyp + " twenty pence coins, " + tenp + " ten pence coins " + fivep + " five pence coins, " + twop + " two pence coins and " + onep + " pennies.");    
 
int changegiven(change, currency) {
	int counter;
